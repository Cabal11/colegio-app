...
export default function fechas() {
  ...
  useEffect(() => {
    ...
    var mesActual = "Junio"; /* Enero Febrero Marzo Abril Mayo Junio*/
    var mesEncontrado = meses.find(
      (m) => m.mes.toLowerCase() === mesActual.toLowerCase()
    );
    console.log("actual" + mesActual + "rncontrado" + mesEncontrado);
    if (mesEncontrado) {
      setMes(mesEncontrado.mes);
      setdiasEspeciales(mesEncontrado.dias);
      console.log("mes: ", mesEncontrado.mes);
      console.log("dias: ", mesEncontrado.dias);
    }
  }, []);
